...
class Locks2(Locks):
   ...
   num_clients = 40
   loops = 10
   requests = ["/home.html", "/output.cgi?0.3", "/favicon.ico", "/output.cgi?0.2"]
...
class Light(Locks):
   ...
   num_clients = 5
   loops = 20
   requests = ["/home.html", "/output.cgi?0.1", "/favicon.ico", "/output.cgi?0.02"]
...
class Light2(Locks):
   ...
   num_clients = 4
   loops = 30
   requests = ["/home.html", "/output.cgi?0.0112", "/favicon.ico"]
